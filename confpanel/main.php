      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  ...
                  <h3>
                    ...
                    $username = "id14244460_admin";
                    $password = "I|2fB7P0owP~>1Y8";
                    $dbname = "id14244460_db_companyprofile";
                    ...
                    $sql = "SELECT table_schema \"id14244460_db_companyprofile\",
                            ROUND(SUM(data_length + index_length) / 1024 / 1024, 1) \"DB Size in MB\" 
                            FROM information_schema.tables WHERE table_schema = 'id14244460_db_companyprofile' GROUP BY table_schema";
                    ...
                    ?>
                        ...
                        </div><p>Kapasitas penyimpanan database yang sudah dipakai saat ini !</p>                     
                      </div>
          ...
          <div class="row mt">
            ...
            <div class="custom-bar-chart">
              ...
              $konek = mysqli_connect('localhost','id14244460_admin','I|2fB7P0owP~>1Y8','id14244460_db_companyprofile');
