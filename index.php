<?php
    $link = mysqli_connect("localhost","id14244460_admin","I|2fB7P0owP~>1Y8","id14244460_db_companyprofile");
    include "control.php"; 
...
//fungsi fitur kirim email
        ...
        $to      = "arga.aditia@gmail.com";
        
        $headers = "MIME-Version: 1.0" . "\r\n";
        $headers .= "Content-type:text/html;charset=iso-8859-1" . "\r\n";

        // More headers
        $headers .= 'From: <info@cosplayhobby.000webhostapp.com/>' . "\r\n";
        $headers .= 'Cc: admin@cosplayhobby.000webhostapp.com/' . "\r\n";
                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="pop">
                        ...
                        <form id="contact" action="index.php" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="hidden" name="date_receive_inbox" id="date" value="<?php echo date('Y-m-d' ); ?>">  
                                  <fieldset>
                ...
                <div class="col-md-2 col-sm-12">
                    <div class="connect-us">
                        ...
                        <ul>                            
                            ...
                            <li><a href=\"https://www.twitter.com/$showcontactus[id_twitter]\" target=\"_blank\"><i class=\"fa fa-twitter\"></i></a></li>
                            <li><a href=\"https://www.instagram.com/$showcontactus[id_instagram]\" target=\"_blank\"><i class=\"fa fa-instagram\"></i></a></li>
                            <li><a href=\"https://www.youtube.com/$showcontactus[id_youtube]\" target=\"_blank\"><i class=\"fa fa-youtube\"></i></a></li>
                        </ul>";
                            }
                        ?>
                        <?php 
